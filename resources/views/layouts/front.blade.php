...
<head lang="en">
    ...
    <title>GYW- Fashion at sustianable price</title>
            ...
            <div class="col-lg-8 col-lg-offset-2">
                ...
                <div class="heading align-center mb60">
                    <h4 class="h1 heading-title">
                        <a href="/">GYW</a></h4>
                    <p class="heading-text">Get your wardrobe. Get your dream fashionable items without sacrificing the planet.
                    </p>
                </div>
...
<footer class="footer">
    ...
    <!-- Copyright -->
    <div class="footer-copyright text-center py-3">© 2019 March Sarangua Tsogtoo- Medieinstitutet
    </div>
    <!-- Copyright -->
